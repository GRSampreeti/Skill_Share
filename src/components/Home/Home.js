...
const Home = () => {
  return (
    ...
    <div className="container">
      ...
      <Stack direction={["column", "row"]} spacing={["16"]} justifyContent={["center", "space-around"]} alignItems={['center', 'center']}>
        <VStack alignItems={["center", "flex-end"]} padding={["20px", "20px"]} justifyContent={["center", "center"]}  >
          <Heading className="text">Learn Together, Grow Together </Heading>
          <Text className="text">Empowering Knowledge Sharing Between Peers</Text>
          <Link to="/courses" >
    ...
    <Box className="container2" bg="blackAlpha.800" >
      ...
      <HStack width={"100%"}  height={["100px", "100px"]} justifyContent={"space-around"}>
